...
ajax.onreadystatechange = () => {
    if (ajax.status == 200 && ajax.readyState == 4) {
        ...
        for (let i = 0; i < dados.length; i++) {
            ...
            <tr id="tag_${dados[i]._id}">
                ...
                <td> <ion-icon name="trash-outline" > </ion-icon> <ion-icon name="create-outline" onclick="patchEmployee('tag_${dados[i]._id}');" width = "100px"> <ion-icon> 
                </td>
            </tr>
            `
        }
    ...
    document.getElementById('totalTags').innerHTML = res.length;
